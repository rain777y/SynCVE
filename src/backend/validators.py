...
class AnalyzeRequest(BaseModel):
    ...
    client_capture_ts: Optional[str] = Field(
        default=None,
        max_length=64,
        description="Client-side ISO timestamp captured before frame submission",
    )
    client_frame_id: Optional[Union[int, str]] = Field(
        default=None,
        description="Client-side monotonic frame identifier for this session",
    )
